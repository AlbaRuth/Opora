...
class AgentLog(Base, TimestampMixin):
    ...
    agent_type: Mapped[str] = mapped_column(String(50), nullable=False, index=True)  # "therapist", "evaluator"
    task_name: Mapped[str] = mapped_column(String(100), nullable=False, index=True)  # "generate_response", "assess_emotion", etc.
    ...
    langfuse_trace_id: Mapped[Optional[str]] = mapped_column(String(255), nullable=True, index=True)
    langfuse_generation_id: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
